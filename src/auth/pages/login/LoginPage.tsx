                    ...
                    <form className='p-6 md:p-8' onSubmit={handleLogin}>
                        <div className='flex flex-col gap-6'>
                            ...
                            <div className='grid gap-2'>
                                ...
                                <Input id='email' type='email' name='email' placeholder='mail@google.com' autoComplete='name' required />
                            </div>
                            <div className='grid gap-2'>
                                ...
                                <Input id='password' type='password' name='password' placeholder='Contraseña' autoComplete='email' required />
                            </div>
