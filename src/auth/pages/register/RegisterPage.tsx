    ...
    return (
        <div className={'flex flex-col gap-6'}>
                    ...
                    <form className='p-6 md:p-8' onSubmit={handleRegister}>
                        <div className='flex flex-col gap-6'>
                            ...
                            <div className='grid gap-2'>
                                ...
                                <Input id='fullName' type='text' name='fullName' placeholder='Nombre Completo' autoComplete='name' required />
                            </div>
                            <div className='grid gap-2'>
                                <Label htmlFor='email'>Correo</Label>
                                <Input id='email' type='email' name='email' placeholder='mail@google.com' autoComplete='email' required />
                            </div>
                            <div className='grid gap-2'>
            ...
            <div className='text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary'>
                Haciendo click estas de acuerdo con nuestros <a href='#'>Términos, Condiciones</a> y <a href='#'>Políticas de Privacidad</a>.
            </div>
        </div>
    );
};
