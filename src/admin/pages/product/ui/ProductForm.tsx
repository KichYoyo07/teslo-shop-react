            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
                            ...
                            <div className='space-y-6'>
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                    ...
                                    <div>
                                        ...
                                        />
                                        {errors.stock && <p className='text-red-500 text-sm'>El inventario debe de ser mayor a 0</p>}
                                    </div>
                                </div>
                    ...
                    <div className='space-y-6'>
                        {/* Product Images */}
                        <div className='bg-white rounded-xl shadow-lg border border-slate-200 p-6'>
                            <h2 className='text-xl font-semibold text-slate-800 mb-6'>Imágenes del producto</h2>
                        ...
                        <div className='bg-white rounded-xl shadow-lg border border-slate-200 p-6'>
                            ...
                            <div className='space-y-4'>
                                ...
                                <div className='flex items-center justify-between p-3 bg-slate-50 rounded-lg'>
                                    ...
                                    <span className='text-sm text-slate-600'>{product.images.length} imágenes</span>
                                </div>
